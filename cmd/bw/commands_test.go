...
func TestCmdDeletePreview(t *testing.T) {
	...
	var buf bytes.Buffer
	err := cmdDelete([]string{iss.ID}, PlainWriter(&buf))
	if err != nil {
...
func TestCmdDeletePreviewDoesNotModify(t *testing.T) {
	...
	var buf bytes.Buffer
	cmdDelete([]string{iss.ID}, PlainWriter(&buf))
...
func TestCmdDeleteForce(t *testing.T) {
	...
	var buf bytes.Buffer
	err := cmdDelete([]string{iss.ID, "--force"}, PlainWriter(&buf))
	if err != nil {
...
func TestCmdDeleteForceJSON(t *testing.T) {
	...
	var buf bytes.Buffer
	err := cmdDelete([]string{iss.ID, "--force", "--json"}, PlainWriter(&buf))
	if err != nil {
...
func TestCmdDeleteNonexistent(t *testing.T) {
	...
	var buf bytes.Buffer
	err := cmdDelete([]string{"test-zzzz", "--force"}, PlainWriter(&buf))
	if err == nil {
		t.Error("expected error for nonexistent issue")
	}
}

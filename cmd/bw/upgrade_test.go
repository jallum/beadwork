...
func TestCmdUpgradeUpToDate(t *testing.T) {
	...
	var buf bytes.Buffer
	_, err := cmdUpgrade(nil, []string{}, PlainWriter(&buf), nil)
	if err != nil {
...
func TestCmdUpgradeCheckOnly(t *testing.T) {
	...
	var buf bytes.Buffer
	_, err := cmdUpgrade(nil, []string{"--check"}, PlainWriter(&buf), nil)
	if err != nil {
...
func TestCmdUpgradeYesFlag(t *testing.T) {
	...
	var buf bytes.Buffer
	_, err := cmdUpgrade(nil, []string{"--yes"}, PlainWriter(&buf), nil)
	if err != nil {
...
func TestCmdUpgradeRoutesToRepo(t *testing.T) {
	...
	var buf bytes.Buffer
	_, err := cmdUpgrade(nil, []string{"repo"}, PlainWriter(&buf), nil)
	if err == nil {
